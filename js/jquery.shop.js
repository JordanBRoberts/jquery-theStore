...
function myFunction23() {
    alert("Order Confirmed! Reference number #198467pty");
}
...
(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.$cupTotal = this.$element.find( "#ctotal" ); // Element that displays the subtotal charges
			...
			this.$paypalForm = this.$element.find( "#paypal-form" ); // PayPal for
		...
		handleAddToCartForm: function() {
			...
			self.$formAddToCart.each(function() {
				...
				$form.on( "submit", function() {
					...
					var cupTotal = qty * price - 34;
					

					self.storage.setItem( self.total, sTotal , cupTotal);
					self._addToCart({
						product: name,
						price: price,
						qty: qty
